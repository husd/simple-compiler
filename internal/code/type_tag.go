...
var TYPE_TAG_BYTE = &TypeTag{byte_class, byte_superclasses, true}
var TYPE_TAG_CHAR = &TypeTag{char_class, char_superclasses, true}
var TYPE_TAG_SHORT = &TypeTag{short_class, short_superclasses, true}
var TYPE_TAG_LONG = &TypeTag{long_class, long_superclasses, true}
var TYPE_TAG_FLOAT = &TypeTag{float_class, float_superclasses, true}
var TYPE_TAG_INT = &TypeTag{int_class, int_superclasses, true}
var TYPE_TAG_DOUBLE = &TypeTag{double_class, double_class, true}
var TYPE_TAG_BOOLEAN = &TypeTag{0, 0, true}

/** The tag of the type `void'.
 */
var TYPE_TAG_VOID = &TypeTag{0, 0, false}

/** The tag of all class and interface types.
 */
var TYPE_TAG_CLASS = &TypeTag{0, 0, false}

// 数组
var TYPE_TAG_ARRAY = &TypeTag{0, 0, false}

/** The tag of all (monomorphic) method types. 单态方法类型
 */
var TYPE_TAG_METHOD = &TypeTag{0, 0, false}

/** The tag of all package "types".
 */
var TYPE_TAG_PACKAGE = &TypeTag{0, 0, false}

/** The tag of all (source-level) type variables.
 */
var TYPE_TAG_TYPEVAR = &TypeTag{0, 0, false}

/** The tag of all type arguments. 范型类型
 */
var TYPE_TAG_WILDCARD = &TypeTag{0, 0, false}

/** The tag of all polymorphic (method-) types. 多态方法类型
 */
var TYPE_TAG_FORALL = &TypeTag{0, 0, false}

/** The tag of deferred expression types in method context
 */
var TYPE_TAG_DEFERRED = &TypeTag{0, 0, false}

/** The tag of the bottom type {@code <null>}.
 */
var TYPE_TAG_BOT = &TypeTag{0, 0, false}
var TYPE_TAG_NONE = &TypeTag{0, 0, false}
var TYPE_TAG_ERROR = &TypeTag{0, 0, false}
var TYPE_TAG_UNKNOWN = &TypeTag{0, 0, false}
var TYPE_TAG_UNDETVAR = &TypeTag{0, 0, false}

/** Pseudo-types, these are special tags
 */
var TYPE_TAG_UNINITIALIZED_THIS = &TypeTag{0, 0, false}
var TYPE_TAG_UNINITIALIZED_OBJECT = &TypeTag{0, 0, false}
